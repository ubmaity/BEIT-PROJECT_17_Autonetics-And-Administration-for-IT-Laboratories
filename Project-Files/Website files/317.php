...
if($con)
{	
	echo "<h3   style='font-family: verdana; font-size:30px;color:#88FF33;border-style: outset;text-align: center;'>317 Lab Records</h3>";
	$query = "SELECT batch,username,subject,room,date_time FROM id10740292_root WHERE room='317' ORDER BY room ASC";
