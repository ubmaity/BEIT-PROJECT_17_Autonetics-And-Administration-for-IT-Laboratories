...
{	
	...
	$query = "SELECT batch,username,subject,room,date_time FROM id10740292_root WHERE batch='B1' AND year='BE' ORDER BY batch ASC";
	...
	$query = "SELECT batch,username,subject,room,date_time FROM id10740292_root WHERE batch='B2' AND year='BE' ORDER BY batch ASC";
	$result = mysqli_query($con,$query);
	if(mysqli_num_rows($result) == 0)
	{
		echo "<h2 style='font-size: 18px;text-align: center;'>No entries found currently</h2>";
	...
	$query = "SELECT batch,username,subject,room,date_time FROM id10740292_root WHERE batch='B3' AND year='BE' ORDER BY batch ASC";
	$result = mysqli_query($con,$query);
	if(mysqli_num_rows($result) == 0)
	{
		echo "<h2 style='font-size: 18px;text-align: center;'>No entries found currently</h2>";
